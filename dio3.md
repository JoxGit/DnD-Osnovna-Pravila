...
Ovo poglavlje pruža pravila za bajanje čarolijama. Različite klase karaktera imaju različite načine učenja i pripremanja svojih uroka, a čudovišta koriste uroke na jedinstvene načine. Bez obzira na izvor, čarolija sledi pravila ovde.
...
Svaka čarolija ima nivo od 0 do 9. Nivo čarolije je opšti pokazatelj koliko je moćna, sa niskom (ali i dalje impresivnim) magičnom raketom na 1. nivou i neverovatnim vremenskim zaustavljanjem na 9. nivou. Čari (Cantrips) - jednostavne, ali moćne čarolije koje likovi mogu da izvršavaju gotovo napamet - su nivo 0. Što je veći nivo uroka, to mora viši nivo spellcastera biti da bi koristio tu čaroliju.
...
Pre nego što magičar može da koristi čaroliju, mora imati na umu čvrsto fiksiranu čaroliju ili mora imati pristup čaroliji u magičnom predmetu. Članovi nekoliko klasa imaju ograničenu listu čarolija koje znaju i koje su uvek na umu. Ista stvar je i za mnoga čudovišta koja koriste magiju. Ostali vračari, poput sveštenika i čarobnjaka, prolaze kroz proces pripreme uroka. Ovaj proces varira za različite klase, kako je detaljno opisano u njihovim opisima.

U svakom slučaju, broj čarolija koje igrač može da ima na umu u bilo kom trenutku zavisi od nivoa lika.


#### Slotovi čarolija

Bez obzira na to koliko uroka magičar zna ili se pripremi, on ili ona mogu da naprave samo ograničeni broj uroka pre nego što se odmore. Manipulisanje magijskim tkivom i usmeravanje njegove energije u čak i jednostavnu čaroliju fizički je i mentalno zahtjevno, a čarolije višeg nivoa su čak i veće. Prema tome, opis svake klase magičara sadrži tabelu koja prikazuje koliko slotova svakog nivoa čarolije može da koristi lik na svakom nivou lika. Na primer, čarobnjak 3. nivoa, Umara ima četiri slota za čaroliju 1. nivoa i dva slota za 2. nivo.
...
Neki likovi i čudovišta imaju posebne sposobnosti koje im omogućavaju da bacaju čarolije bez upotrebe slotova za uroke.


##### Bacanje čarolije na višem nivou

Kada bacač čarolija baci čaroliju koristeći slot koji je višeg nivoa od čarolije koju baca, čarolija pretpostavlja viši nivo za to bacanje. Na primer, ako Umara baci magičnu raketu koristeći jedan od svojih slotova drugog nivoa, ta magična raketa je drugi nivo. Efektivno, čarolija se širi ispunjavajući mesto u koje je stavljena.

Neke čarolije, poput magijske rakete i lečenja rana, imaju snažnije efekte kada se bace na viši nivo, kao što je detaljno opisano u opisu čarolije.


#### Cantrips

Cantrip je čarolija koja se može bacati po volji, bez upotrebe slota za čarolije i bez prethodne pripreme. Ponovljena praksa fiksirala je čaroliju u umu magičara i ulila čaroliju potrebnu za ponavljanje efekta. Nivo čarolije kantripa je 0.
...
Da bi bacio čaroliju kao ritual, bacač čarolija mora imati osobinu koja mu daje mogućnost. Na primer, sveštenik i druid imaju takvu osobinu. Magičar takođe mora imati pripremljenu čaroliju ili na njenoj ili njenoj listi čarolija, osim ako ritualna karakteristika lika ne navodi drugačije, kao što to čini čarobnjak.


### Bacanje čarolije

Kada lik baci bilo koju čaroliju, poštuju se ista osnovna pravila, bez obzira na klasu lika ili efekte čarolije.
...
Većina uroka ima opsege izražene u stopalima. Neke čarolije mogu ciljati samo stvorenje (uključujući i vas) kojeg dodirnete. Ostale čarolije, poput čarolije štita, utiču samo na vas.
...
Zbog mentalnog fokusa i preciznih gesta potrebnih za pravljenje čarolija, morate biti vešti u oklopu koji nosite da biste bacili čaroliju. Inače ste previše rastreseni i fizički ometeni od strane okloba da bi bacali čarolije


#### Komponente

Komponente čarolije su fizički zahtevi koje morate da ispunite da biste ih bacili. Opis svake čarolije ukazuje na to da li je potrebno verbalno (V), somatsko (S), ili materijalno (M). Ako ne možete da obezbijedite jednu ili više komponenti čarolije, ne možete da napravite čaroliju.
...
Pokreti bacanja čarolije mogu uključivati snažnu gestikulaciju ili složeni niz gesta. Ako je za čaroliju potrebna somatska komponenta, bacač mora da koristi najmanje jednu ruku da bi izvodio ove gestove.


##### Materijalno (M)

Za izvođenje nekih čarolija potrebni su određeni objekti, navedeni u zagradama u unosu komponente. Lik može da koristi torbicu sa komponentom ili fokus za čaranje (pronađen u poglavlju 5) umesto komponenata navedenih za čaroliju. Ali ako je za komponentu naznačen trošak, lik mora imati tu određenu komponentu pre nego što on ili ona može da napravi čaroliju.

Ako čarolija kaže da čarolija troši materijalnu komponentu, kotač mora da je obezbedi za svako bacanje uroka.

Propovednik čarolija mora imati slobodnu ruku za pristup ovim komponentama - ili za zadržavanje fokusa izgovaranja - ali to može biti ista ruka koju on ili ona koristi za izvođenje somatskih komponenti.
...
Mnogo uroka je trenutno. Čarolija šteti, leči, stvara ili menja biće ili predmet na način koji se ne može oterati, jer njegova magija postoji samo za trenutak.
...
• **Preuzimanje štete**. Kad god primite štetu dok se koncentrišete na čaroliju, morate da izvršite spasonosno bacanje da biste održali koncentraciju. DC je jednak 10 ili polovini štete koju ste pretrpeli, koji god broj bude veći. Ako nanesete štetu iz više izvora, kao što su strela i zmajev dah, za svaki izvor štete izvršite zasebno spasilačko bacanje.

• **Biti onesposobljen ili ubijen**. Gubite koncentraciju na čaroliju ako ste onesposobljeni ili ako umrete.

DM takođe može odlučiti da određeni fenomeni životne sredine, poput talasa koji se sruši na vas dok ste na brodu koji baca oluja, zahtevaju da uspete u spasilačkom bacanju DC 10 kako biste održali koncentraciju na uroku.
...
Da biste ciljali nešto, morate imati jasan put do njega, tako da ne može biti iza potpuno zaklonjeno.
...
Magijske škole pomažu u opisivanju uroka; nemaju svoja pravila, iako se neka pravila odnose na škole.

**Čarolije odbacivanja** su zaštitne prirode, mada neke od njih imaju agresivnu upotrebu. Oni stvaraju magične barijere, negiraju štetne efekte, štete prekršiocima ili proteruju stvorenja u drugim nivoima postojanja.

**Čarolije uroka** uključuju prevoz predmeta i stvaranje sa jedne lokacije na drugoj. Neke čarolije prizivaju stvorenja ili predmete na stranu magičara, dok druge omogućavaju magičaru da se teleportuje na drugo mesto. Neke konjuracije stvaraju objekte ili efekte ni iz čega.
...
**Čarolije nekromantije** manipulišu energijom života i smrti. Takve čarolije mogu pružiti dodatni rezervu životne snage, iscrpiti životnu energiju iz drugog bića, stvoriti nemrtve ili čak vratiti mrtve u život.

Stvaranje nemrtvih pomoću čarolije nekromantije kao što je oživljavanje mrtvih nije dobar čin, a samo zli magičari često ih koriste.

**Čarolije transmutacije** menjaju svojstva bića, predmeta ili okoline. Mogli bi pretvoriti neprijatelja u bezazleno stvorenje, ojačana snaga saveznika, pokreće predmet po zapovesti bacača ili pojača urođene sposobnosti lečenja stvorenja da se brzo oporavi od povreda.


##### Kupa

Konus se pruža u pravcu koji odaberete od njegove tačke porekla. Širina konusa u datoj tački duž njegove dužine jednaka je udaljenosti te tačke od tačke početka. Područje efekta konusa određuje njegovu maksimalnu dužinu.
...
Mnogo uroka precizira da meta može da izvrši spasonosno bacanje kako bi izbegla neke ili sve efekte uroka. Čarolija određuje sposobnost koju meta koristi za spremanje i šta se dešava u slučaju uspeha ili neuspeha. DC da se odupre jednoj vašoj čaroliji jednak je 8 + vaš modifikator sposobnosti bacanja čarolije + vaš bonus za znanje + bilo koji specijalni modifikator.


#### Bacanja napada

Neke čarolije zahtevaju od bacača da izvrši napad, kako bi utvrdio da li efekat čarolije pogađa predviđeni metu. Vaš bonus za napad sa čarolijom jednak je vašem modifikatoru sposobnosti za sposobnost bacanja + bonusu za znanje.
...
#### Kombinovanje magičnih efekata

Efekti različitih čarolija se sabiraju dok se trajanja tih čarolija preklapaju. Međutim, efekti iste čarolije izvedene više puta se ne kombinuju. Umesto toga, primenjuje se najmoćniji efekat - kao što je najviši bonus - od tih odlivaka dok se njihova trajanja preklapaju. Ili se primenjuje najnoviji efekat ako su odlivci podjednako snažni i ako im se trajanje preklapa.
...
Smrtnici ne mogu direktno da oblikuju ovu sirovu magiju. Umesto toga, oni koriste magično tkivo, neku vrstu interfejsa između volje čarobnjaka i sirove magije. Vradžbine zaboravljenih carstava nazivaju ga Tkanjem i prepoznaju njegovu suštinu kao boginju Mistru, ali bacači magija imaju različite načine imenovanja i vizualizacije ovog interfejsa. Bilo kojim imenom, bez Tkanja, sirova magija je zaključana i nepristupačna; najmoćniji arhimag ne može da osvetli sa magijom u predelu gde je Tkanje pokidano. Ali okružen Veaveom, bacač čarolija može oblikovati grom kako bi eksplodirao neprijatelje, prevaliti stotine kilometara u tren oka ili čak obrnuti samu smrt.

Sva magija zavisi od Veave-a, mada mu različite vrste magije pristupaju na razne načine. Čarolije čarobnjaka, veštaca, vrača i barda obično se nazivaju tajnom magijom. Ove čarolije se oslanjaju na razumevanje - naučeno ili intuitivno - delovanja Veave-a. bacač vuče direktno niti Veave-a kako bi stvorio željeni efekat. Vitezovi Eldritch i tajni prevaranti takođe koriste tajnu magiju. Čarolije sveštenika, druida, paladina i rendžera nazivaju se božanskom magijom. Pristup ovih čarobnjaka Tkanju posreduje božanska sila - bogovi, božanske prirodne sile ili sveta težina zakletve paladina.
...
Pogledaj knjigu za više detalja
